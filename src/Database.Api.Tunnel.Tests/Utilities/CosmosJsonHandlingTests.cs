...
namespace Database.Api.Tunnel.Tests.Utilities;
...
public class CosmosJsonHandlingTests
{
    ...
    public void CosmosQueryResponse_CanSerializeJsonElementDictionary()
    {
        ...
        var response = new Database.Api.Tunnel.Models.Responses.CosmosQueryResponse
        {
            Success = true,
            Data = sampleData
        };
        ...
        // Deserialize it back
        var deserialized = JsonSerializer.Deserialize<Database.Api.Tunnel.Models.Responses.CosmosQueryResponse>(json);
